...
namespace FinanClickApi.Migrations
{
    ...
    [Migration("20241126053715_payment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanClickApi.Models.Actividad", b =>
                {
                    ...
                    b.HasKey("IdActividad")
                        .HasName("PK__Activida__5EAF86A4864D3F7C");
            ...
            modelBuilder.Entity("FinanClickApi.Models.Amortizacion", b =>
                {
                    ...
                    b.Property<DateOnly?>("FechaMoratorio")
                        .HasColumnType("DATE")
            ...
            modelBuilder.Entity("FinanClickApi.Models.DetalleProducto", b =>
                {
            ...
            modelBuilder.Entity("FinanClickApi.Models.Documento", b =>
                {
                    ...
                    b.HasKey("IdDocumento")
                        .HasName("PK__Document__E520734746846EF9");
            ...
            modelBuilder.Entity("FinanClickApi.Models.DocumentosEmpresa", b =>
                {
                    b.Property<int>("IdDocumentoEmpresa")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdDocumentoEmpresa"));
                    ...
                    b.HasKey("IdDocumentoEmpresa")
                        .HasName("PK__Document__D8E796008CB5341B");

                    b.HasIndex("IdDocumento");

                    b.HasIndex("IdEmpresa");

                    b.ToTable("DocumentosEmpresa", (string)null);
                });
            ...
            modelBuilder.Entity("FinanClickApi.Models.PaymentRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("IdEmpresaNavigationIdEmpresa")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdEmpresaNavigationIdEmpresa");
            ...
            modelBuilder.Entity("FinanClickApi.Models.DocumentosEmpresa", b =>
                {
                    b.HasOne("FinanClickApi.Models.Documento", "IdDocumentoNavigation")
                        .WithMany("DocumentosEmpresas")
                        .HasForeignKey("IdDocumento")
                        .IsRequired()
            ...
            modelBuilder.Entity("FinanClickApi.Models.PaymentRequest", b =>
                {
                    b.HasOne("FinanClickApi.Models.Empresa", "IdEmpresaNavigation")
                        .WithMany()
                        .HasForeignKey("IdEmpresaNavigationIdEmpresa");
            ...
            modelBuilder.Entity("FinanClickApi.Models.Documento", b =>
                {
                    b.Navigation("DocumentosEmpresas");
                });
